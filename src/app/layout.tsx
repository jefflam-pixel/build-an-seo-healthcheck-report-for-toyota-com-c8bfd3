...
const navLinks = [
  ...
  { href: "/scoring-framework", label: "Scoring framework" },
  { href: "/seo-analysis", label: "Seo analysis" },
  { href: "/recommendations", label: "Recommendations" },
  { href: "/seo-healthcheck", label: "Seo healthcheck" },
      ...
      <body className="min-h-screen bg-gray-50">
        ...
        >
          <div className="p-6 border-b border-slate-700">
            <h1 className="text-xl font-bold">Build an SEO healthcheck report for Toyota.com</h1>
